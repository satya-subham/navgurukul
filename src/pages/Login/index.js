...
import { Typography, Container, Grid, Stack, Box, Button, TextField } from "@mui/material";
          ...
          <Grid item xs={12} ms={6} md={6}>
            <Container maxWidth="md">
              ...
              {loading ? (
                ...
                >
                  <form>
                  <TextField id="outlined-basic" label="Enter Email" variant="outlined" style={{margin: '10px 0px'}}/> <br />
                  <TextField id="outlined-basic" label="Enter Password" variant="outlined" /> <br />
                  <Button variant="contained" type="submit" style={{margin: '10px 10px 10px 0px'}}>Log In</Button>
              ...
              <TextField id="outlined-basic" label="Enter mobile no" variant="outlined" /> <br />
              <Button variant="contained" style={{margin: '10px 0px'}}>Log In with Mobile</Button><br />
